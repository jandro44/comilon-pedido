    ...
    return (
        ...
        <div className="w-275 h-[200px] min-w-[275px] md:w-300 md:min-w-[300px]  bg-cardOverlay rounded-lg py-2 px-4  my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative">
            <div className="w-full flex items-center justify-between">
                ...
                <div className="text-white w-8 h-8 rounded-full bg-red-600 flex items-center justify-center cursor-pointer hover:shadow-md -mt-8"
            ...
            <div className="w-full flex flex-col items-center justify-center -mt-12 mb-5">
                ...
                <div className="flex items-center gap-8">
                    <p className="text-lg text-headingColor font-semibold">
                        <span className="text-sm text-red-500">Subtotal $</span> {producto.precio * producto.cantidad}
                    </p>
                </div>
            </div>
        </div>
